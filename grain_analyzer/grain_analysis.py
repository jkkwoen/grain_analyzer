...
Migration Guide:
    ...
    # 새 코드:
    from grain_analyzer.segmentation import segment_classical
...
class AFMGrainAnalyzer:
    ...
    새 코드에서는 함수 기반 API를 사용하세요:
        - segment_classical(), segment_stardist()
    ...
    def __init__(self):
        warnings.warn(
            ...
            "segment_classical() 및 calculate_grain_statistics() 함수를 사용하세요.",
            DeprecationWarning,
            stacklevel=2
        )
...
def segment_by_marker_growth(
    ...
    *,
    ...
    새 코드에서는 segment_classical()을 사용하세요.
